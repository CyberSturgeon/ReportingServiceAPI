    ...
    BaseRepository<Transaction>(context), ITransactionRepository
{
    ...
    {
            await context.Database.ExecuteSqlRawAsync("SELECT InsertTransaction(@p_id,@p_account_id,@p_amount,@p_date," +
                ...
                new NpgsqlParameter("p_date", DateTime.SpecifyKind(transaction.Date, DateTimeKind.Utc))
                {
